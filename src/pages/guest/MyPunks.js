        ...
        setTimeout(async () => {
            ...
            try {
                ...
                if (selectedWalletAddress !== "" && window.web3 && window.contract) {
                    // console.log("1", selectedWalletAddress);
                    ...
                    for (let i = 0; i < tokenBalance; i++) {
                        let number = await window.contract.methods.tokenOfOwnerByIndex(selectedWalletAddress, i).call();
                        allMyPunks.push(number)
                    }
                    
                    await CT.storage.PUNKS.map(punk => {
                        allMyPunks.map(myPunk => {
                            myPunk == punk.idx && _punks.push({
                                ...punk,
                            })
                        })
                    })
                                    ...
                                    <div className="my_balance">
                                        <div className="counter">
                                            ...
                                            <div className="currency">
                                                <p>
                                                    Pending Withdraw <strong className="cash">{window.web3Global.utils.fromWei(interf.withdrawable)}</strong> HT
                                                </p>
                                            </div>
                                        </div>
