...
export default class PunkPage extends Component {
    ...
    async bridge_makeBid() {
        this.CT.swal(null, {
            ...
            <div class="InputBox -full">
                <input type="text" placeholder="more than ${this.state.storage.bids ? window.web3.utils.fromWei(this.state.storage.bids.value) : '8'}" id="NEWBID-BID_PRICE" />
    ...
    async _makeBid() {
        ...
        setTimeout(async () => {
            try {
                if (storage.bids && window.web3.utils.toWei(form.newbid_price) > storage.bids.value && form.newbid_price >= 8 || !storage.bids) {
                ...
                } else if (form.newbid_price < 8) {
                    this.CT.swal('error', {
                        title: `Bid value must be more than 8`,
                        body: `
                        `
                    })
                    this._sst('interf', { isBidding: false })
    ...
    async bridge_makeOffer() {
        this.CT.swal(null, {
            ...
            body: `
                ...
                <br />
                <div class="InputBox -full">
                    <input type="text" placeholder="more than 8" id="MAKEOFFER-OFFER_PRICE" />
                    <i class="ri-input-cursor-move"></i>
                </div>
            `,
            modify: {
    ...
    async _makeOffer() {
        ...
        setTimeout(async () => {
            try {
                if (form.newoffer_price >= 8) {
                    !isApproved ? this._firstApproveThen(() => _makeOfferNow()) : _makeOfferNow()
                } else {
                    this.CT.swal('error', {
                        title: 'New Offer value must be more than 8',
                        body: `
                        `
                    })
                    this._sst('interf', { isOffering: false })
                    ...
                    <div className="punk_details">
                        <div className="profile">
                            <div className="profile_picture">
                                <div className="IC">
                                    <img src={`https://thunderpunks.com/punks/pic/${props.match.params.id}.png`} alt="" />
                                </div>
                            </div>
                            <div className="profile_info">
                                ...
                                <div className="record owner">
                                    ...
                                    <div className="value">
                                        {interf.owner && <a href={`https://scan.thundercore.com/address/${interf.owner}`} target="_blank">
                                            <span>
                                ...
                                {storage.offer &&
                                interf.owner.toLowerCase() === storage.offer.seller.toLowerCase() &&
                                <div className="record price">
                                    ...
                                    <div className="value">
                                            <span>
                                                {storage.offer.minValue && window.web3Global.utils.fromWei(storage.offer.minValue)} HT
                                            </span>
                                    </div>
                                </div>
                                }
                                        ...
                                        <div className="Actions">
                                            {interf.isOffering
                                                ...
                                                <a className="Btn -simple2" onClick={() => this.bridge_makeOffer()}>
                                                    ...
                                                    <span>
                                                        {!(storage.offer && interf.owner.toLowerCase() === storage.offer.seller.toLowerCase()) ? 'Offer it for sale' : 'Change Offer'}
                                                    </span>
                                                </a>
                                            }
                                    ...
                                    <C.Content full>
                                        <table>
                                            ...
                                            interf.owner.toLowerCase() === storage.offer.seller.toLowerCase()
                                                ?
                                                <tr>
                                                    <td>{storage.offer.seller && <a href={`https://scan.thundercore.com/address/${storage.offer.seller}`} target="_blank">{storage.offer.seller.toLowerCase() === selectedWallet ? 'me' : this.CT.utils.walletAddress(storage.offer.seller)}</a>}</td>
                                    ...
                                    <C.Content full>
                                        <table>
                                            ...
                                            {storage.bids
                                                ?
                                                <tr>
                                                    <td>{storage.bids.bidder && <a href={`https://scan.thundercore.com/address/${storage.bids.bidder}`} target="_blank">{storage.bids.bidder.toLowerCase() === selectedWallet ? 'me' : this.CT.utils.walletAddress(storage.bids.bidder)}</a>}</td>
