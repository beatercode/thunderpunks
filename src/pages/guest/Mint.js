...
export default class Mint extends Component {
    ...
    async mint() {
        ...
        try {
            ...
            let selectedWallet = await WalletManager.getSelectedWallet();
    ...
    async _mint(wallet) {
        ...
        try {
            window.contract.methods.mintNFT(this.state.form.punksCount).send({
                from: wallet,
                value: window.web3Global.utils.toWei((this.state.form.punksCount * 9000) + ""),
            }, (error, result) => {
                ...
                <div className="minter">
                    ...
                    <div className="body">
                        ...
                        <div className="description">
                            ...
                            <p className="secondP">
                                9000 TT to mint a ThunderPunk
                            </p>
                            <p>
                                ThunderPunks left: {this.state.PunkLeft}
                            </p>
                        </div>
                        <div className="act">
                                        ...
                                        <div className="InputBox" style={{
                                            ...
                                            <div className="box">
                                                <select defaultValue="1" value={form.punksCount || "1"} className="dropdown" id="punks_number" name="punks_number" onChange={(e) => this.setPunksCount(e.target.value)} >
                                                    <option value="1">1 x ThunderPunk</option>
                                                    <option value="2">2 x ThunderPunk</option>
                                                    <option value="5">5 x ThunderPunk</option>
                                                    <option value="10">10 x ThunderPunk</option>
                                                    <option value="20">20 x ThunderPunk</option>
                                                </select>
                                            </div>
                                        </div>
                                        {form.punksCount &&
