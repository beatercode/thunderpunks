...
export default class Home extends Component {
    ...
    async checkPunkLeft() {
        try {
            let remain = await window.contractGlobal.methods.punksRemainingToAssign().call();
            this.setState({
                PunkLeft: remain
            })
        } catch (e) {
                        ...
                        <div className="body">
                            ...
                            <div className="minter">
                                <div className="description">
                                    <p>
                                        Mint a ThunderPunk before all are gone 😉
                                    </p>
                                </div>
                                <div className="act">
                    ...
                    <div className="whywe">
                        ...
                        <div className="answers">
                            <div className="answer -full_col -item1">
                                ...
                                <div className="body">
                                    <p>
                                        In the interest of fairness and to give everyone the chance to own one (or more) ThunderPunks, the purchase is made on a random basis.
                            ...
                            <div className="answer -full_row -item2">
                                ...
                                <div className="body">
                                    <p>
                                        The identity of the ThunderPunks will remain a mystery until your purchase is completed. No first come, first serve, everyone has an equal chance to get the the rare punks such as ape, zombie or aliens.
                                    </p>
                                </div>
                            </div>
                            <div className="answer -full_row -item3">
                                ...
                                <div className="body">
                                    <p>
                                        Our Marketplace page will be ready once all ThunderPunks are minted. You can get as many ThunderPunks as you want but once the 10,000 are sold it will be too late to get one at mint cost.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="cta_mint">
                        ...
                        <div className="text">
                            <p>
                                ...
                                Cryptopunks are now on thundercore! Don't miss the chance to own them
                            </p>
                        </div>
                        <div className="act">
                            <div className="Actions">
