...
export default class Market extends Component {
    ...
    async _loadData() {
        ...
        let punks = [];
        console.log(forSalePunks);
        await CT.storage.PUNKS.map(async punk => {
            forSalePunks.map(forSalePunk => {
                if(forSalePunk.owner.toLowerCase() === forSalePunk.punksOfferedForSale.seller.toLowerCase()) {
                    currentPunkIndex = forSalePunk.punksOfferedForSale.punkIndex;
